...
// Ensures the demo account's password is always correct before attempting login.
// Returns true if the account already exists in MongoDB (use login), false if it needs signup.
